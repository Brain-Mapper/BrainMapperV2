...
class SOMView(QtGui.QWidget):
    ...
    def setupUi(self, Form):
        ...
        self.pushButton_5.setMessage("test")
        ...
        self.gridLayout_5.addWidget(self.lineEdit_step, 6, 3, 1, 1)
        self.pushButton_4 = self.help_button_height = InfoButton(self.widget_param)
        self.pushButton_4.setMessage("test")
        ...
        self.gridLayout_5.addWidget(self.lineEdit_std, 10, 3, 1, 3)
        ...
        self.gridLayout_5.addWidget(self.lineEdit_nbiter, 4, 3, 1, 1)
        self.pushButton_7 = self.help_button_height = InfoButton(self.widget_param)
        self.pushButton_7.setMessage("test")
        ...
        self.gridLayout_5.addWidget(self.label_nbiter, 4, 5, 1, 3)
        ...
        self.gridLayout_5.addWidget(self.lineEdit_largeur, 1, 3, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.lineEdit_hauteur, 0, 3, 1, 1)
        self.pushButton_3 = self.help_button_height = InfoButton(self.widget_param)
        self.pushButton_3.setMessage("test")
        ...
        self.pushButton_2.setMessage("test")
        ...
        self.pushButton_6.setMessage("test")
