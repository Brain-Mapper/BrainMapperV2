...
class SOMView(QtGui.QWidget):
    ...
    def setupUi(self, Form):
        ...
        self.widget_param_global.setStyleSheet(_fromUtf8("QWidget#widget_param_global{background-color: rgb(255, 255, 255);}"))
        ...
        self.widget_param.setStyleSheet(_fromUtf8("QWidget#widget_param{background-color: rgb(255, 255, 255);}"))
        ...
        self.pushButton_train = QtGui.QPushButton(Form)
        font = QtGui.QFont()
        font.setPointSize(9)
    ...
    def retranslateUi(self, Form):
        ...
        self.label_nbiter.setText(_translate("Form", "Iteration number", None))
