...
class CalculationView(QtGui.QWidget):
    ...
    def stack15UI(self):
        ...
        options.setStyleSheet("background-color: #FFCC33;")
        layout.addRow(options)
        layout.addWidget(QLabel("Coefficient for multiplication :"))
        self.paramMultiplication = QLineEdit("1")
        layout.addWidget(self.paramMultiplication)
        ...
        descbox = QtGui.QVBoxLayout()
        description = QTextEdit("Add a description.")
        description.setSizePolicy(QSizePolicy.Expanding, QSizePolicy.Expanding)
        description.setReadOnly(True)
    ...
    def stack16UI(self):
        ...
        options.setStyleSheet("background-color: #FFCC33;")
        layout.addRow(options)
        layout.addWidget(QLabel("Coefficient for division :"))
        self.paramDivision = QLineEdit("1")
        layout.addWidget(self.paramDivision)
...
# ----- ---------------------------------------------------
    ...
    def runCalculation(self):
        ...
        if algorithm=="Division":
            try:
                try:
                    div_coef = float(self.paramDivision.text())
                except:
                    div_coef = 1
